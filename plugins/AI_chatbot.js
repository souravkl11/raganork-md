...
New.addCommand({on: 'text', fromMe: false, deleteCommand: false}, (async (message, match) => {
		...
		if (!!message.mention && message.mention[0] == message.client.user.jid) { await message.client.sendMessage(message.jid, conf.M_REPLY, MessageType.text, {quoted: message.message}) }
	}
