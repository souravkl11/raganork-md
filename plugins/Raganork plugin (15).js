...
Raganork.addCommand({ pattern: 'brainly ?(.*)', fromMe: true, desc: brainly, usage: usage }, async (message, match) => {
...
Raganork.addCommand({ pattern: 'brainly ?(.*)', fromMe: false, desc: brainly, usage: usage }, async (message, match) => {
