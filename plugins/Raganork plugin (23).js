...
if (Config.WORKTYPE == 'private') {
    ...
    Raganork.addCommand({ pattern: 'rgb ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
    ...
    Raganork.addCommand({ pattern: 'rgb ?(.*)', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
