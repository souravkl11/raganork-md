...
const malayalamToManglish = r => {
    ...
    const a = {
        ക്ക: "kk", ഗ്ഗ: "gg", ങ്ങ: "ng", ക്ക: "kk", ച്ച: "cch", 
        ജ്ജ: "jj", ഞ്ഞ: "nj", ട്ട: "tt", ണ്ണ: "nn", ത്ത: "tth", 
        ദ്ദ: "ddh", ദ്ധ: "ddh", ന്ന: "nn", ന്ത: "nth", ങ്ക: "nk", 
        ണ്ട: "nd", ബ്ബ: "bb", പ്പ: "pp", മ്മ: "mm", യ്യ: "yy", 
        ല്ല: "ll", വ്വ: "vv", ശ്ശ: "sh", സ്സ: "s", ക്സ: "ks", 
        ഞ്ച: "nch", ക്ഷ: "ksh", മ്പ: "mp", റ്റ: "tt", ന്റ: "nt", 
        ന്ത: "nth", ന്ത്യ: "nthy"
    };
    ...
    const t = {
        ല്: "l", ള്: "l", ണ്: "n", ന്: "n", ര്: "r", ക്ക്: "k"
    };
    
    const o = {
        "ു്": "u", "ാ": "aa", "ി": "i", "ീ": "ee", "ു": "u", 
        "ൂ": "oo", "ൃ": "ru", "െ": "e", "േ": "e", "ൈ": "y", 
        "ൊ": "o", "ോ": "o", "ൌ": "ou", "ൗ": "au", "ഃ": "a"
    };
    ...
    function h(r) {
        ...
        for (const l in a) {
            if (a.hasOwnProperty(l)) {
                h = a[l];
                r = (r = (r = r.replace(RegExp(l + "്([\\w])", "g"), h + "$1"))
                    .replace(RegExp(l + "്", "g"), h + "u"))
    ...
    function p(r, e) {
        for (let a = 0, n = RegExp("(" + l(r).join("|") + ")(" + l(o).join("|") + ")", "g"); null != a;) {
