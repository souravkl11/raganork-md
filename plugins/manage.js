...
Module({
    ...
    const settingsMatch = message.message.match(/^\d+$/);
    if (message.message.startsWith(handler + "settings") && settingsMatch) {
    ...
    } else if (message.message.match(/^(1|2)$/) && message.quoted?.message) {
