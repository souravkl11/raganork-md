...
const baseConfig = {
    ...
    ANTIWORD_WARN: process.env.ANTIWORD_WARN || 'fuck',
    ...
    IMGBB_KEY: ["fGkw4gGK", "deb80cd12ababea1c9b9a8ad6ce3fab2", "78c84c62b32a88e86daf87dd509a657a"],
    RG: process.env.RG || '919074309534-1632403322@g.us,120363116963909366@g.us',
    BOT_INFO: process.env.BOT_INFO || '𝙎𝙐𝞖𝞓𝞘𝙇 𝞦𝞢𝞒;Suhail;default',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.NOT_ALLOWED || '852',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || 'null',
    STICKER_DATA: process.env.STICKER_DATA || "≛͢⃝⃖✯⎈͢𝑺᪵𝑼͢𝑯𝑨𝑰𝑳᪵𖠇𝑺᪵𝑬𝑹᭄⎈͢ ≛⃝⃗➳",
    BOT_NAME: process.env.BOT_NAME || '◉─━〔 𝙎𝙐𝞖𝞓𝞘𝙇-𝞑𝞗𝙏-𝞛𝘿 〕━─◉',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? '≛͢⃝⃖✯⎈͢𝑺᪵𝑼͢𝑯𝑨𝑰𝑳᪵𖠇𝑺᪵𝑬𝑹᭄⎈͢ ≛⃝⃗➳;◉─━〔 𝙎𝙐𝞖𝞓𝞘𝙇-𝞑𝞗𝙏-𝞛𝘿 〕━─◉;https://i.imgur.com/6uLmYzw.jpeg' : process.env.AUDIO_DATA,
