...
module.exports = {
    ...
    SONGD: process.env.SONGD === undefined ? 'ඔබ සෙවූ ගීතය downloading...' : process.env.SONGD,
    SONGU: process.env.SONGU === undefined ? 'ඔබ සෙවූ ගීතය uploading...' : process.env.SONGU,
