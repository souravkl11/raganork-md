...
const SESSION = SESSION_STRING ? SESSION_STRING.split('RGNK~GbC40kcX').map(s => s.split("~")[1].trim()) : [];
...
const baseConfig = {
    ...
    ANTI_SPAM: process.env.ANTI_SPAM || '919074309534-1632403322@g.us'true,
    ...
    ALLOWED: process.env.ALLOWED || '91,94,2'92,
